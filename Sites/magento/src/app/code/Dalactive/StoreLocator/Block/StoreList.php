    ...
    public function getStoresJson(): string
    {
        ...
        foreach ($this->getStores() as $store) {
            ...
            $stores[] = [
                ...
                'latitude' => $latitude,
                'longitude' => $longitude,
                'ghnProvinceId' => $store->getData('ghn_province_id') ? (int) $store->getData('ghn_province_id') : null,
                'ghnDistrictId' => $store->getData('ghn_district_id') ? (int) $store->getData('ghn_district_id') : null,
                'ghnWardCode' => (string) $store->getData('ghn_ward_code'),
