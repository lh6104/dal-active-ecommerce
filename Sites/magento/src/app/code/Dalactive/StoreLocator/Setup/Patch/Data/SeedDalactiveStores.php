...
class SeedDalactiveStores implements DataPatchInterface
{
    ...
    public function apply(): self
    {
        ...
        $connection->delete($table, ['identifier NOT IN (?)' => $identifiers]);
    ...
    private function getStores(): array
    {
        return [
            ...
            [
                'name' => 'DAL Active Lạng Sơn',
                'identifier' => 'dal-active-lang-son',
            ...
            [
                'name' => 'DAL Active Bắc Ninh',
                'identifier' => 'dal-active-bac-ninh',
