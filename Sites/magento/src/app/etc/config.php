...
return [
    'modules' => [
        ...
        'Dalactive_StoreLocator' => 1,
        'Dalactive_GhtkShipping' => 1,
        'Dalactive_HeroBanner' => 1,
        'Dalactive_HybridauthAutoload' => 1,
        'Dalactive_LazyLoad' => 1,
        'Dalactive_Navbar' => 1,
        'Dalactive_PhotoReview' => 1,
        'Dalactive_Sepay' => 1,
        'Dalactive_ShoppingAssistant' => 1,
        'Dalactive_SizeGuide' => 1,
        'Dalactive_SportsNews' => 1,
        'Dalactive_StockAlert' => 1,
        'Dalactive_GhnShipping' => 1,
        'Dalactive_Weather' => 1,
        ...
        'Risecommerce_AutoRelatedProducts' => 1,
        'Vnpayment_VNPAY' => 1
    ]
];
